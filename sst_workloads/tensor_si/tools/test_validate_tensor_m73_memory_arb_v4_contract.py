#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m73_memory_arb_v4_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m73_memory_arb_v4_contract.py"


class ValidateTensorM73MemoryArbV4ContractTest(unittest.TestCase):
