#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m97_scaleout_v2_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m97_scaleout_v2_contract.py"


class ValidateTensorM97ScaleoutV2ContractTest(unittest.TestCase):
