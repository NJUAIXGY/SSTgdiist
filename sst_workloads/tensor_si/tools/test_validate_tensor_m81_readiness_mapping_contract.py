#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m81_readiness_mapping_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m81_readiness_mapping_contract.py"


class ValidateTensorM81ReadinessMappingContractTest(unittest.TestCase):
