#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m79_ras_policy_v4_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m79_ras_policy_v4_contract.py"


class ValidateTensorM79RasPolicyV4ContractTest(unittest.TestCase):
