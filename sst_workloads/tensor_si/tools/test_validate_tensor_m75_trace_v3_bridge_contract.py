#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m75_trace_v3_bridge_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m75_trace_v3_bridge_contract.py"


class ValidateTensorM75TraceV3BridgeContractTest(unittest.TestCase):
        ...
        return {
            ...
            "workload": {
                "params": {
                    ...
                    "tensor_trace_v3_barrier_count": barriers,
