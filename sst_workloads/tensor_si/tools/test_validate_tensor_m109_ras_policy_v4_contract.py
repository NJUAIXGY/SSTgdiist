#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m109_ras_policy_v4_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m109_ras_policy_v4_contract.py"


class ValidateTensorM109RasPolicyV4ContractTest(unittest.TestCase):
