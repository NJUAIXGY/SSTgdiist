#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for compile_tensor_trace_v2_to_spec.py."""
...
SCRIPT = THIS_DIR / "compile_tensor_trace_v2_to_spec.py"


class CompileTensorTraceV2ToSpecTest(unittest.TestCase):
    def test_compile_success(self) -> None:
        with tempfile.TemporaryDirectory() as td:
                ...
                json.dumps(
                    {
                        ...
                        "program_ops": [
                            ...
                            {"op_type": "gemm_ub", "cycles": 64, "ub_read_bytes": 2048, "ub_write_bytes": 1024, "resource": "mxu", "deps": [0]},
            ...
            self.assertGreater(params.get("tensor_trace_v2_dependency_edges", 0), 0)
