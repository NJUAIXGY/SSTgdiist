#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m92_pipeline_scoreboard_v3_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m92_pipeline_scoreboard_v3_contract.py"


class ValidateTensorM92PipelineScoreboardV3ContractTest(unittest.TestCase):
