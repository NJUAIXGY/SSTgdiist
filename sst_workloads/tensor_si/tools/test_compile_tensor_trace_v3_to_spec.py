#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for compile_tensor_trace_v3_to_spec.py."""
...
SCRIPT = THIS_DIR / "compile_tensor_trace_v3_to_spec.py"


class CompileTensorTraceV3ToSpecTest(unittest.TestCase):
    def test_compile_success(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(params.get("tensor_trace_v3_version"), 3)
            self.assertGreater(params.get("tensor_trace_v3_dependency_edges", 0), 0)
            self.assertEqual(params.get("tensor_trace_v3_barrier_count"), 2)
