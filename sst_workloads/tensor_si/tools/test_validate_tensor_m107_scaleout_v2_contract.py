#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m107_scaleout_v2_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m107_scaleout_v2_contract.py"


class ValidateTensorM107ScaleoutV2ContractTest(unittest.TestCase):
