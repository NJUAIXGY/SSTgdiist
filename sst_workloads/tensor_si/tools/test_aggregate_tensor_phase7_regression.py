#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for aggregate_tensor_phase7_regression.py."""
...
SCRIPT = THIS_DIR / "aggregate_tensor_phase7_regression.py"


class AggregateTensorPhase7RegressionTest(unittest.TestCase):
    def test_pass_report(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            root = Path(td)
            results = root / "results.tsv"
            out = root / "report.json"
            results.write_text("m101\tpass\t/tmp/m101\t/tmp/m101.log\nm102\tpass\t/tmp/m102\t/tmp/m102.log\n", encoding="utf-8")
