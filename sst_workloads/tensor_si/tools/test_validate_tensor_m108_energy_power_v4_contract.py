#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m108_energy_power_v4_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m108_energy_power_v4_contract.py"


class ValidateTensorM108EnergyPowerV4ContractTest(unittest.TestCase):
