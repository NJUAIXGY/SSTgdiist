#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unit tests for validate_tensor_m82_pipeline_scoreboard_v3_contract.py."""
...
SCRIPT = THIS_DIR / "validate_tensor_m82_pipeline_scoreboard_v3_contract.py"


class ValidateTensorM82PipelineScoreboardV3ContractTest(unittest.TestCase):
