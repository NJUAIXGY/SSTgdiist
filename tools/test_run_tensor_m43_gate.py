#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""CLI tests for tools/run_tensor_m43_gate.sh."""
...
SCRIPT = REPO_ROOT / "tools" / "run_tensor_m43_gate.sh"


class RunTensorM43GateTest(unittest.TestCase):
    def test_help(self) -> None:
        out = subprocess.run(["bash", str(SCRIPT), "--help"], text=True, capture_output=True, cwd=str(REPO_ROOT))
        self.assertEqual(out.returncode, 0, msg=out.stderr)
        self.assertIn("run_tensor_m43_gate.sh", out.stdout)
