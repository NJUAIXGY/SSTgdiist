...
CASE_ID="${1:-}"
if [ -z "$CASE_ID" ]; then
  echo "usage: $0 <idx2_ingress_carry_guard_a1_r48|idx2_ingress_carry_guard_a2_r32>" >&2
  exit 2
fi
...
case "$CASE_ID" in
  idx2_ingress_carry_guard_a1_r48)
    CASE_ENV=(
    ...
    ;;
  idx2_ingress_carry_guard_a2_r32)
    CASE_ENV=(
      MESH_EXPERIMENTAL_IDX2_INGRESS_PREFETCH_APPLY_MAX_INFLIGHT=2
      MESH_EXPERIMENTAL_IDX2_INGRESS_PREFETCH_APPLY_OUTSTANDING_RESERVE=32
    )
    ;;
  *)
