...
CASE_ID="${1:-}"
if [ -z "$CASE_ID" ]; then
  echo "usage: $0 <pulse_shared_line_actual_mfb_gather_preband_metadata_txn_off|pulse_shared_line_actual_mfb_gather_preband_metadata_txn_rowdescriptor_ttl256|pulse_shared_line_actual_mfb_gather_preband_metadata_txn_rowidx_ttl256|pulse_shared_line_actual_mfb_gather_preband_metadata_txn_idx2_ttl256|pulse_shared_line_actual_mfb_gather_preband_metadata_txn_preband_ttl256|pulse_shared_line_actual_mfb_gather_preband_metadata_txn_all_ttl256>" >&2
  exit 2
fi
...
case "$CASE_ID" in
  ...
  pulse_shared_line_actual_mfb_gather_preband_metadata_txn_rowdescriptor_ttl256)
    CASE_ENV=(
      ...
      MESH_PULSE_OSA_METADATA_READY_LEASE_TTL=256
      MESH_PULSE_OSA_METADATA_OBJECT_MASK=rowdescriptor
    )
    ;;
  pulse_shared_line_actual_mfb_gather_preband_metadata_txn_rowidx_ttl256)
    CASE_ENV=(
      ...
      MESH_PULSE_OSA_METADATA_READY_LEASE_ENABLE=1
      MESH_PULSE_OSA_METADATA_READY_LEASE_TTL=256
      MESH_PULSE_OSA_METADATA_OBJECT_MASK=rowidx
    )
    ;;
  pulse_shared_line_actual_mfb_gather_preband_metadata_txn_idx2_ttl256)
    CASE_ENV=(
      ...
      MESH_PULSE_OSA_METADATA_READY_LEASE_ENABLE=1
      MESH_PULSE_OSA_METADATA_READY_LEASE_TTL=256
      MESH_PULSE_OSA_METADATA_OBJECT_MASK=idx2
    )
    ;;
  pulse_shared_line_actual_mfb_gather_preband_metadata_txn_preband_ttl256)
    CASE_ENV=(
      ...
      MESH_PULSE_OSA_METADATA_READY_LEASE_ENABLE=1
      MESH_PULSE_OSA_METADATA_READY_LEASE_TTL=256
      MESH_PULSE_OSA_METADATA_OBJECT_MASK=preband
    )
    ;;
  pulse_shared_line_actual_mfb_gather_preband_metadata_txn_all_ttl256)
    CASE_ENV=(
      ...
      MESH_PULSE_OSA_METADATA_READY_LEASE_ENABLE=1
      MESH_PULSE_OSA_METADATA_READY_LEASE_TTL=256
      MESH_PULSE_OSA_METADATA_OBJECT_MASK=all
    )
    ;;
  *)
