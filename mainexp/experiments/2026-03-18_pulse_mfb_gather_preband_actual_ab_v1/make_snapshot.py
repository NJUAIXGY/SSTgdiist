#!/usr/bin/env python3
"""Build a compare.tsv snapshot for the PULSE-MFB gather-preband actual-service run."""
...
PULSE_METRICS: Tuple[str, ...] = (
    ...
    "pulse_mfb_gather_owner_lines_useful_ratio",
    "pulse_mfb_gather_owner_lines_dead_ratio",
...
def _write_compare(
    ...
    lines = [
        ...
        "# profile\tpulse_mfb_gather_preband_actual_c3",
        "\t".join(header),
    ]
