#!/usr/bin/env python3
"""Build a minimal compare.tsv snapshot for the PULSE GCSS shared-line actual-service Stage-A run."""
...
PULSE_METRICS: Tuple[str, ...] = (
    ...
    "pulse_actual_gate_enable_false_total",
    "pulse_actual_gate_window_zero_total",
    "pulse_actual_gate_line_too_small_total",
    "pulse_actual_gate_taken_total",
    "pulse_service_hit_ratio",
    "pulse_service_owner_ratio",
    "pulse_service_request_compaction",
)
