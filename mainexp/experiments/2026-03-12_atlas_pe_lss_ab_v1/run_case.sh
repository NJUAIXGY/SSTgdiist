...
CASE_ID="${1:-}"
if [ -z "$CASE_ID" ]; then
  echo "usage: $0 <baseline_step1_seed_only_frac003|atlas_pe_storage_only_step1_seed_only_frac003|atlas_pe_lss_step1_seed_only_frac003>" >&2
  exit 2
fi
...
case "$CASE_ID" in
  ...
  atlas_pe_storage_only_step1_seed_only_frac003)
    ...
    ;;
  atlas_pe_lss_step1_seed_only_frac003)
    CASE_ENV=(
