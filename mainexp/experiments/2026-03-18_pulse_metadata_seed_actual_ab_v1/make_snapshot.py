#!/usr/bin/env python3
"""Build a minimal compare.tsv snapshot for the PULSE metadata-seed actual-service F2 run."""
...
PULSE_METRICS: Tuple[str, ...] = (
    ...
    "pulse_metadata_seed_candidates_total",
    ...
    "pulse_metadata_seed_prefetch_owner_total",
    "pulse_metadata_seed_prefetch_issue_deferred_total",
...
def _write_compare(
    ...
    lines = [
        ...
        "# profile\tpulse_metadata_seed_actual_f2",
