...
- matrix_label: `codesign_single_20us_20260322`
...
| --- | --- | --- | --- | --- | --- |
| traffic_mem_bundle_vs_direct | full_3d | full_3d_tile_bundle_v3 | 0 | 34318 | 17338 |
...
| --- | --- | --- | --- | --- | --- |
| runtime_adaptive_vs_mapping | 0.000 | 0.000 | 1.000 | 1.000 | thermal_guard_actions |
| runtime_adaptive_vs_thermal_guard | 0.094 | 0.000 | 1.000 | 1.000 | thermal_guard_actions |
...
- dominant_endpoint_counts: `{"pe_nic": 1, "unavailable": 1}`
- dominant_memory_axis_counts: `{"controller_service_deficit_proxy": 1, "vertical_link_pressure": 1}`
...
| --- | --- | --- | --- | --- | --- |
| traffic_mem_bundle_vs_direct | pe_nic | controller_service_deficit_proxy | synapse_gather | same_xy_cross_tier | stable |
| traffic_mem_monolithic_vs_hbm | unavailable | vertical_link_pressure | unavailable | tier_local_home | unevaluable |
