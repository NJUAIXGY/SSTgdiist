...
- compare_route_memory_overlap_mode_counts: `{"bootstrap_bound": 1}`
- route_memory_overlap_mode_transition_counts: `{"bootstrap_bound->bootstrap_bound": 1}`
- compare_control_trigger_signal_counts: `{"memory_barrier_coupling_proxy": 1, "memory_thermal_coupling_proxy": 1, "route_memory_overlap": 1, "route_memory_overlap_mode": 1, "vertical_link_pressure": 1}`
...
- homeroute_adjustment_count_delta_sum: `1.000`

| compare_kind | compare_control_decision | compare_control_decision_source | compare_control_trigger_signals_csv | route_memory_overlap_mode_transition | vertical_link_pressure_delta | stack_hotspot_penalty_delta | route_thermal_coupling_score_delta | memory_thermal_coupling_proxy_delta | memory_barrier_coupling_proxy_delta | homeroute_adjustment_count_delta | thermal_guard_actions_delta | dominant_runtime_axis |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| runtime_adaptive_vs_full_3d | executed_control | hybrid | memory_barrier_coupling_proxy|memory_thermal_coupling_proxy|route_memory_overlap|route_memory_overlap_mode|vertical_link_pressure | bootstrap_bound->bootstrap_bound | 0.238 | 0.132 | 0.102 | -0.172 | 69704.000 | 1.000 | 2.000 | memory_barrier_coupling_proxy |

## Mechanism Progression

- progression_signature: `controller_outstanding -> stable_or_zero -> memory_barrier_coupling_proxy`
...
- progression_interpretation: `fixed-step window-route is dominated by controller_outstanding; stop-window shifts to stable_or_zero, without same-controller overlap; runtime compare shifts to memory_barrier_coupling_proxy.`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| traffic_mem_bundle_vs_direct | pe_nic | controller_memory_pressure_proxy | backpressure | bootstrap_bound->bootstrap_bound | 3.879 | 3.879 | unavailable | same_xy_cross_tier | stable |
| traffic_mem_monolithic_vs_hbm | mixed | controller_memory_pressure_proxy | backpressure | bootstrap_bound->bootstrap_bound | -5.021 | -5.021 | unavailable | same_xy_cross_tier | alignment_improved |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| runtime_adaptive_vs_full_3d | traffic_mem_monolithic_vs_hbm | controller_memory_pressure_proxy | executed_control | hybrid | memory_barrier_coupling_proxy|memory_thermal_coupling_proxy|route_memory_overlap|route_memory_overlap_mode|vertical_link_pressure | controller_pressure_to_memory_coupling_trigger | beneficial | aligned_runtime_control_with_visible_actions | memory_barrier_coupling_proxy | pressure -> runtime decision -> outcome: traffic_mem_monolithic_vs_hbm exposes backpressure-backed composite (source=backpressure->backpressure, backpressure-delta=-5.021, composite-delta=-5.021); runtime runtime_adaptive_vs_full_3d selects executed_control via hybrid, triggers=memory_barrier_coupling_proxy|memory_thermal_coupling_proxy|route_memory_overlap|route_memory_overlap_mode|vertical_link_pressure, and lands on memory_barrier_coupling_proxy (memory_thermal_delta=-0.172, memory_barrier_delta=69704.000, homeroute_delta=1.000, thermal_guard_delta=2.000); alignment=controller_pressure_to_memory_coupling_trigger; effect=beneficial (aligned_runtime_control_with_visible_actions). |
