...
- matrix_label: `mainline_blueprint_smoke`
...
- vertical_link_pressure_delta_sum: `0.244`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| runtime_adaptive_vs_full_3d | executed_control | hybrid | route_memory_overlap|stack_hotspot_penalty|vertical_link_pressure | 0.244 | 0.250 | 0.000 | 0.000 | 0.000 | 2.000 | 2.000 | thermal_guard_actions |
...
| 3 | runtime_compare | 1 | thermal_guard_actions | no | compare_kinds={"runtime_adaptive_vs_full_3d": 1} |
