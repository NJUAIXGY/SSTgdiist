...
- matrix_label: `authority_native_matrix_refresh_20260402`
...
- earliest_same_controller_overlap_stop_at: `5us`
- max_steps_completed_delta: `238`
...
| window_stop_bundle_vs_direct | 5us | 0 | 0 | 0.000 | controller_outstanding |
| window_stop_monolithic_vs_direct | 5us | 101 | 1 | 0.000 | controller_outstanding |
| window_stop_bundle_vs_direct | 10us | -1 | 1 | 0.000 | controller_outstanding |
| window_stop_monolithic_vs_direct | 10us | 238 | 1 | 0.000 | controller_outstanding |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| runtime_adaptive_vs_full_3d | executed_control | hybrid | memory_barrier_coupling_proxy|memory_thermal_coupling_proxy|route_memory_overlap|vertical_link_pressure | bootstrap_manifest->native_multicast_synapse_home | bootstrap_bound->native_synapse_aligned | 0.000 | 0.000 | 0.102 | -0.172 | 69704.000 | 2.000 | 2.000 | memory_barrier_coupling_proxy |
...
- earliest_same_controller_overlap_stop_at: `5us`
- phase_transition_flags: `{"route_to_runtime_axis_shift": true, "route_to_stop_axis_shift": false, "same_controller_overlap_emerged": true, "stop_to_runtime_axis_shift": true}`
- progression_interpretation: `fixed-step window-route is dominated by controller_outstanding; stop-window remains controller_outstanding, and same-controller overlap appears at 5us; runtime compare shifts to memory_barrier_coupling_proxy.`
...
| 2 | window_stop | 6 | controller_outstanding | no | same_controller_overlap@5us |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| traffic_mem_bundle_vs_direct | pe_nic | controller_memory_pressure_proxy | backpressure | bootstrap_manifest->bootstrap_manifest | bootstrap_bound->bootstrap_bound | 3.879 | 3.879 | unavailable | same_xy_cross_tier | stable |
| traffic_mem_monolithic_vs_hbm | mixed | controller_memory_pressure_proxy | backpressure | bootstrap_manifest->bootstrap_manifest | bootstrap_bound->bootstrap_bound | -5.021 | -5.021 | unavailable | same_xy_cross_tier | alignment_improved |
