...
| --- | --- | --- | --- | --- | --- |
| 1 | window_route | 1 | controller_outstanding | no | alignment={"alignment_degraded": 1} |
| 2 | window_stop | 4 | controller_outstanding | no | same_controller_overlap@10us |
...
| --- | --- | --- | --- | --- | --- |
| traffic_mem_bundle_vs_direct | pe_nic | controller_service_deficit_proxy | stream_region | same_xy_cross_tier | stable |
