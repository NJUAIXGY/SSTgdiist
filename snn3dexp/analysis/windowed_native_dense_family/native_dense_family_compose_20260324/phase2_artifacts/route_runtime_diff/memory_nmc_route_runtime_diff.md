...
| --- | --- | --- | --- | --- | --- | --- | --- |
| native_dense_fixed_step_4_10us | full_3d_snn_window | full_3d_snn_window_bundle_v3 | stable | 0 | 0 | 0 | 0 |

## Window Route Mechanism Focus

- row_count: `1`
- dominant_axis_counts: `{"stable_or_zero": 1}`
- alignment_transition_counts: `{"stable": 1}`
...
| --- | --- | --- | --- | --- | --- | --- |
| native_dense_fixed_step_4_10us | 0.000 | 0.000 | 0 | 0 | stable | stable_or_zero |
...
- progression_signature: `stable_or_zero -> unavailable -> unavailable`
- window_route_dominant_axis: `stable_or_zero`
...
- progression_interpretation: `fixed-step window-route is dominated by stable_or_zero; stop-window evidence is unavailable; runtime compare evidence is unavailable.`

| phase_order | phase | row_count | dominant_axis | phase_transition_from_previous | key_signal |
| --- | --- | --- | --- | --- | --- |
| 1 | window_route | 1 | stable_or_zero | no | alignment={"stable": 1} |
...
- dominant_endpoint_counts: `{"unavailable": 1}`
...
| --- | --- | --- | --- | --- | --- |
| traffic_mem_monolithic_vs_hbm | unavailable | reliability_penalty | unavailable |  | stable |
