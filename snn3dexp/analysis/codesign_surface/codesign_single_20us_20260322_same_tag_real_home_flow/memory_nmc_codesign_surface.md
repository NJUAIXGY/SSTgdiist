...
| traffic_mem_monolithic_vs_hbm | full_3d | full_3d_monolithic_proxy | 101184 | -50598 | -32500 | 0.000 | -17807 | -0.038 | 0.084 |
...
| traffic_mem_monolithic_vs_hbm | memory_requests | memory_requests_total | 101184 | 2.728 |
| traffic_mem_monolithic_vs_hbm | service | total_service_deficit | -50598 | 0.442 |
| traffic_mem_monolithic_vs_hbm | topology | vertical_hops_ratio | -0.421 | 0.000 |
...
| traffic_mem_monolithic_vs_hbm | home_access_class | same_xy_cross_tier_total_demands | 32500 | 2.625 |
| traffic_mem_monolithic_vs_hbm | home_access_class | remote_home_total_demands | -32500 | 0.188 |
| traffic_mem_monolithic_vs_hbm | home_pressure | tier_local_home_service_deficit_attribution | -6310.000 | 0.613 |
| traffic_mem_monolithic_vs_hbm | home_pressure | same_xy_cross_tier_service_deficit_attribution | 9966.000 | 1.610 |
| traffic_mem_monolithic_vs_hbm | home_pressure | remote_home_service_deficit_attribution | -28896.000 | 0.115 |
| traffic_mem_monolithic_vs_hbm | home_pressure | attributed_service_deficit_total | -25240.000 | 0.613 |
| traffic_mem_monolithic_vs_hbm | stack_pressure | active_stack_utilization | 0.000 | 1.000 |
| traffic_mem_monolithic_vs_hbm | stack_pressure | most_pressured_stack_service_deficit | -17807 | 0.220 |
| traffic_mem_monolithic_vs_hbm | stack_pressure | stack_memory_request_skew | -0.033 | 0.968 |
| traffic_mem_monolithic_vs_hbm | stack_pressure | stack_service_deficit_skew | -0.006 | 0.994 |
| traffic_mem_monolithic_vs_hbm | thermal | vertical_link_pressure | -0.038 | 0.797 |
| traffic_mem_monolithic_vs_hbm | reliability | reliability_penalty | 0.084 | 1.207 |
