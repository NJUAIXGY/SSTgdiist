...
# Compare experiment runner (exec_mode=naive_raw, max_steps=4).
# This remains the heavyweight full experiment entrypoint.
# For routine bounded validation, use run_mesh_compare_steps4_naive_raw_smoke.sh instead.
...
exec "$SCRIPT_DIR/run_mesh_exec_mode_compare_with_time.sh" naive_raw
