...
#
# NOTE (N1, nofreeze):
# - keep step_random_activation
# - allow membrane potential to accumulate across steps (step_reset_mem_each_step=0)
# - do NOT enable allow_zero_firing_long by default (expects real firing may occur)
#
# Output root (grouped):
...
# N1/no-freeze: do not reset membranes across steps.
...
export MESH_STEP_ACTIVATION_EVENT_WEIGHT="1.0"
