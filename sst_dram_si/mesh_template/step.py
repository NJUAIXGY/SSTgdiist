...
def build_step_cfg(
    *,
    ...
    return {
        ...
        "reset_mem_each_step": int(bool(state.get("STEP_RESET_MEM_EACH_STEP", 0) or state.get("STEP_SEED_ONLY_MODE", 0))),
        "seed_only_mode": int(state.get("STEP_SEED_ONLY_MODE", 0)),
    }
